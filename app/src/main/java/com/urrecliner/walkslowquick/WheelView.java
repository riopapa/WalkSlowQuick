...
//        }
     ...
     */
    private void invalidateIfYChanged() throws ParseException {
     ...
     * 观察item改变
     */
    private void observeItemChanged() throws ParseException {
        //item改变回调
    ...
    public interface OnWheelChangedListener {
         ...
         * @param newPosition 新下标
         */
        void onWheelItemChanged(int oldPosition, int newPosition) throws ParseException;
